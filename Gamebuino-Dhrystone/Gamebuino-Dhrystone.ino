 ...
 * Modified again for use with Gamebuino-compatible consoles.
...
void setup() {
  ...
  gb.display.println(F("Dhrystone Benchmark, Version 2.1 (Language: C)"));
  ...
  gb.display.print(F("Execution starts, "));
  gb.display.print(Number_Of_Runs);
  gb.display.println(F(" runs through Dhrystone"));
  gb.display.println();
  ...
  gb.display.println(F("Execution ends"));
/*
  printf ("\r\n");
...
*/
  ...
  {
    gb.display.println(F("Measured time too small to obtain meaningful results"));
    gb.display.println(F("Please increase number of runs"));
    gb.display.println();
  }
  else
  {
...
#endif
*/
    gb.display.print(F("Microseconds for one run through Dhrystone: "));
    gb.display.println(Microseconds);
    gb.display.print(F("Dhrystones per Second: "));
    gb.display.println(Dhrystones_Per_Second);
    gb.display.print(F("VAX MIPS rating = "));
    gb.display.println(Vax_Mips);
  //}
}
