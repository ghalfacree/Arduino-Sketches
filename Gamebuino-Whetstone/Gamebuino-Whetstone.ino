...
void setup() {
  gb.display.println("Whetstone Benchmark, Version 1.2 (Language: C)");
}
...
*/
    ...
    if (finisec-startsec <= 0) {
        gb.display.print("Insufficient duration- Increase the LOOP count\n");
        return(1);
    }

    gb.display.print("Loops: ");
    gb.display.print(LOOP);
    gb.display.print(", Iterations: ");
    gb.display.print(II);
    gb.display.print(", Duration: ");
    gb.display.print(finisec-startsec);
    gb.display.println(" ms.");//Arduino measures time in milliseconds
...
//    KIPS = (100.0*LOOP*II)/(float)(finisec-startsec);
    ...
    if (KIPS >= 1000.0){
        gb.display.print("C Converted Single Precision Whetstones: ");
        gb.display.print(KIPS/1000.0);
        gb.display.println(" MIPS");
    }
    else{
        gb.display.print("C Converted Single Precision Whetstones: ");
        gb.display.print(KIPS);
        gb.display.println(" KIPS");
    }
